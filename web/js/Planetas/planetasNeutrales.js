...
$$('.btnEliminar').each(function(item, index){
    ...
    item.addEvent('click', function(e) {
    	cargarSeccion('?controlador=Planetas&accion=eliminar&idGalaxia='+item.getParent().getNext('.idGalaxia').get('value')+'&idPlaneta='+item.getParent().getNext('.idPlaneta').get('value')+'&accionRecargar=planetasNeutrales', $('morphPanelWrap').getFirst('div'), 'jspestana','Planetas','planetasNeutrales');
    });
});
...
$$('.btnAnadir').each(function(item, index){
	item.removeEvents();
    item.addEvent('click', function(e) {
    	cargarSeccion('?controlador=Planetas&accion=anadir&idGalaxia='+item.getParent().getNext('.idGalaxia').get('value')+'&idPlaneta='+item.getParent().getNext('.idPlaneta').get('value')+'&accionRecargar=planetasNeutrales', $('morphPanelWrap').getFirst('div'), 'jspestana','Planetas','planetasNeutrales');
    });
});
...
$$('.paginar a').each(function(el){
	el.addEvent('click', function(e) {
		cargarSeccion(el.get('href'), $('morphPanelWrap').getFirst('div'), 'jspestana','Planetas','planetasNeutrales');
		e.stop();
	});
});