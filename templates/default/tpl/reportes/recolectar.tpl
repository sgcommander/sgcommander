...
<div class="reporteRecursos">
	<div class="reporteTitulo th1">{_RECURSOSMISION}</div>
	<div class="reporteRecurso"><img src="{RECURSOPRIIMG}" alt="{RECURSOPRINOM}" />{RECURSOPRINOM}: <span>{CANTIDADPRIMARIO}</span></div>
	<div class="reporteRecurso"><img src="{RECURSOSECIMG}" alt="{RECURSOSECNOM}" />{RECURSOSECNOM}: <span>{CANTIDADSECUNDARIO}</span></div>
</div>
